import ContinuousTimeMarkovProcessesDiscreteTheoremCanonicalLaneLean.FinalTheorem
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedCTMCPClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_ctmcp_endgame A
